...
//     wxCoord y2p(double y, bool drawOutside = true); // { return (wxCoord) ( (m_posY-y) * m_scaleY); }
    ...
    */
	...
	void FitY(double yMin, double yMax,wxCoord *printSizeX=NULL,wxCoord *printSizeY=NULL);
...
public:
    ...
    */
	...
	void AddDataScrolling(float x, float y, std::vector<double> &xs, std::vector<double> &ys, float deltaX);
